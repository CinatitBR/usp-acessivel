...
class _MapPageState extends State<MapPage> {
  ...
  void _handleSelect(String buildingId) {
    setState(() {
      _showVisualRoutes = false;
      _selectedBuilding = buildingId;
    });
    debugPrint(buildingId);
    _fetchBuildingVisualRoutes(buildingId);
  }
      ...
      children: [
        ...
        if (_selectedBuilding != null)
          CbsoftBottomSheet(
            ...
            visualRoutes: _buildingVisualRoutesList,
          ),
...
class CbsoftBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppBottomSheet(
      ...
      child: ConstrainedBox(
        constraints: const BoxConstraints(maxWidth: 400),
        child: SimposiosList(visualRoutes: visualRoutes),
      ),
    );
  }
}
